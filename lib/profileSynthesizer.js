...
function synthesize(linkedin, cv, sows = []) {
  ...
  return {
    ...
    // LLM-enriched fields (pass-through if cv was an LLM profile)
    elevatorPitch:         c.elevatorPitch         || null,
    phone:                 c.phone                 || null,
    ...
    skills,
    skillTiers:            c.skillTiers            || null,
    certifications:        c.certifications        || [],
    industries,
    industriesRich:        c.industriesRich        || [],
    seniority,
    yearsExperience: yearsExp,
    companySizes,
    workHistory,           // structured job positions from CV
    primaryEngagementType: c.primaryEngagementType || null,

    // Education, languages, preferences (LLM-only fields)
    education:             c.education             || [],
    languages:             c.languages             || [],
    workPreferences:       c.workPreferences       || {},

    // From SOW/contracts
    services:      sowServices.length > 0 ? sowServices : (c.services || []),
    servicesRich:  c.servicesRich   || [],
